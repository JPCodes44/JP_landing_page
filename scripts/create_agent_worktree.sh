...
echo "  3. Run context retrieval (required before any writes):"
echo "       bash scripts/begin_task.sh ${TASK_SLUG}"
echo "  4. Implement, then gate:  bash scripts/run_quality_gates.sh"
echo "  5. Open a PR from $BRANCH to main"
